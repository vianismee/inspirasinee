      ...
      <div className="w-full max-w-2xl mx-auto">
        ...
        <div className="mb-8 flex items-center justify-between text-sm font-medium text-gray-400">
          ...
          <div className="flex items-center">
            <div className="w-8 h-8 rounded-full bg-gray-100 text-gray-500 flex items-center justify-center mr-2 text-sm">
              2
            </div>
            Items
          </div>
          ...
          <div className="p-8">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-500 text-sm">
                Kami memerlukan detail Anda untuk melacak pesanan Anda dan
                memberi tahu Anda saat sudah selesai.
              </p>
            </div>
